...
| Capability worker denies an undeclared resource                                    |      1 |     5 | Now `CLI.CAPABILITY.RESOURCE_DENIED` (`security`, `plugin-incompatible`).                                                                                                                             |
| Capability isolation bridge is missing for a domain that requires a worker         |      1 |     5 | Now `CLI.CAPABILITY.BRIDGE_MISSING` (`plugin-incompatible`).                                                                                                                                          |
