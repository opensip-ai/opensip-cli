...
> External Tool Adapter for govulncheck — wraps Go vulnerability scanning as an opensip-cli tool
...
This package is published for the CLI and advanced plugin authors; most users should not install `@opensip-cli/tool-govulncheck` directly.
...
- 📦 Source: https://github.com/opensip-ai/opensip-cli/tree/v0.8.3/packages/tool-govulncheck
