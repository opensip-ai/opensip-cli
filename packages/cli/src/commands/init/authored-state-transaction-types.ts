...
export const AUTHORED_ARTIFACT_OWNER_KIND = 'opensip-init-authored-artifact' as const;
...
export interface AuthoredStateTransactionDependencies {
  readonly now?: () => number;
  readonly checkpoint?: (checkpoint: AuthoredStateCheckpoint, cursor?: number) => void;
}
