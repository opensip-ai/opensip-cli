...
export function forwardPhaseAtLeast(
...
export function rollbackPhaseAtLeast(
  actual: RuntimePromotionJournal['progress']['phase'],
...
export function runtimePromotionRouteAllows(
...
export function runtimePromotionPendingIntentAllowed(
  ...
  if (!runtimePromotionRouteAllows(journal, intent.kind)) return false;
