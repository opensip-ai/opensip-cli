...
> External Tool Adapter for Bandit — wraps Python security scanning as an opensip-cli tool
...
This package is published for the CLI and advanced plugin authors; most users should not install `@opensip-cli/tool-bandit` directly.
...
- 📦 Source: https://github.com/opensip-ai/opensip-cli/tree/v0.8.2/packages/tool-bandit
