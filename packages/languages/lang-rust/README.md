...
> Rust language adapter for opensip-tools
...
```bash
npm install @opensip-tools/lang-rust
```
...
- 📦 Source: https://github.com/opensip-ai/opensip-tools/tree/v2.10.0/packages/languages/lang-rust
