...
> Java language adapter for opensip-tools
...
```bash
npm install @opensip-tools/lang-java
```
...
- 📦 Source: https://github.com/opensip-ai/opensip-tools/tree/v2.12.0/packages/languages/lang-java
