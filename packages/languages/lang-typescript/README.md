...
> TypeScript/JavaScript language adapter for opensip-tools
...
```bash
npm install @opensip-tools/lang-typescript
```
...
- 📦 Source: https://github.com/opensip-ai/opensip-tools/tree/v2.11.0/packages/languages/lang-typescript
