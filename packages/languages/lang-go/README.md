...
> Go language adapter for opensip-tools
...
```bash
npm install @opensip-tools/lang-go
```
...
- 📦 Source: https://github.com/opensip-ai/opensip-tools/tree/v2.10.1/packages/languages/lang-go
