...
> C/C++ language adapter for opensip-tools (clang-tidy backed)
...
```bash
npm install @opensip-tools/lang-cpp
```
...
- 📦 Source: https://github.com/opensip-ai/opensip-tools/tree/v2.10.1/packages/languages/lang-cpp
