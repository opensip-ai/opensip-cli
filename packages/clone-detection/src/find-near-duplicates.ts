 ...
 *
 * @throws {Error} When `lshBands` does not evenly divide the signature size —
 * a programming-error contract violation (silently returning an empty
 * `complete: true` result would be indistinguishable from "ran clean").
 */
