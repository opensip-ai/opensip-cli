...
# @opensip-tools/graph-go

> Go language adapter for the opensip-tools graph engine
...
```bash
npm install @opensip-tools/graph-go
```
...
- 📦 Source: https://github.com/opensip-ai/opensip-tools/tree/v2.12.0/packages/graph/graph-go
