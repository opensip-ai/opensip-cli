...
> Rust language adapter for the opensip-tools graph engine
...
```bash
npm install @opensip-tools/graph-rust
```
...
- 📦 Source: https://github.com/opensip-ai/opensip-tools/tree/v2.10.1/packages/graph/graph-rust
