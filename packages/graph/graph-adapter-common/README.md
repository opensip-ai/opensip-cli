...
- 🧭 Package catalog (what every package does): https://github.com/opensip-ai/opensip-cli/blob/v0.4.1/docs/public/70-reference/02-package-catalog.md
- 📦 Source: https://github.com/opensip-ai/opensip-cli/tree/v0.4.1/packages/graph/graph-adapter-common
