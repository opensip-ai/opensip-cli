...
- 🧭 Package catalog (what every package does): https://github.com/opensip-ai/opensip-cli/blob/v0.2.4/docs/public/70-reference/02-package-catalog.md
- 📦 Source: https://github.com/opensip-ai/opensip-cli/tree/v0.2.4/packages/graph/graph-adapter-common
