...
# @opensip-tools/graph-adapter-common
...
```bash
npm install @opensip-tools/graph-adapter-common
```
...
- 📦 Source: https://github.com/opensip-ai/opensip-tools/tree/v2.12.0/packages/graph/graph-adapter-common
