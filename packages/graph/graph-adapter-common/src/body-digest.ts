 ...
 * (scan from `start` to the next line terminator) is shared here; each adapter's
...
/** Advance from `start` to the index of the next CR/LF line terminator (or end of text). */
