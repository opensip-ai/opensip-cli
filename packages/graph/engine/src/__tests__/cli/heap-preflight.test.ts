...
// Side-effect import: ensures the TypeScript adapter is registered
// before runHeapPreflight calls pickAdapter. The registry can be torn
// down by sibling tests (lang-adapter-registry) so we re-bootstrap
