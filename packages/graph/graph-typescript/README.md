...
> TypeScript language adapter for the opensip graph engine
...
This package is published for the CLI and advanced plugin authors; most users should not install `@opensip-cli/graph-typescript` directly.
...
- 📦 Source: https://github.com/opensip-ai/opensip-cli/tree/v0.1.16/packages/graph/graph-typescript
