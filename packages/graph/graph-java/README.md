...
# @opensip-tools/graph-java

> Java language adapter for the opensip-tools graph engine
...
```bash
npm install @opensip-tools/graph-java
```
...
- 📦 Source: https://github.com/opensip-ai/opensip-tools/tree/v2.12.0/packages/graph/graph-java
