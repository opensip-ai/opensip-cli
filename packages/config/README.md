...
This package is published for the CLI and advanced plugin authors; most users should not install `@opensip-tools/config` directly.
...
- 📦 Source: https://github.com/opensip-ai/opensip-tools/tree/v3.0.0/packages/config
