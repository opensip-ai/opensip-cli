...
> External Tool Adapter for PMD — wraps Java source analysis as an opensip-cli tool
...
This package is published for the CLI and advanced plugin authors; most users should not install `@opensip-cli/tool-pmd` directly.
...
- 📦 Source: https://github.com/opensip-ai/opensip-cli/tree/v0.8.3/packages/tool-pmd
