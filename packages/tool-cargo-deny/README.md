...
> External Tool Adapter for cargo-deny — wraps Rust dependency policy checks as an opensip-cli tool
...
This package is published for the CLI and advanced plugin authors; most users should not install `@opensip-cli/tool-cargo-deny` directly.
...
- 📦 Source: https://github.com/opensip-ai/opensip-cli/tree/v0.8.4/packages/tool-cargo-deny
