...
> Pure, zero-dependency human presentation formatters and display projections for OpenSIP CLI surfaces (ADR-0144)
...
This package is published for the CLI and advanced plugin authors; most users should not install `@opensip-cli/format` directly.
...
- 📦 Source: https://github.com/opensip-ai/opensip-cli/tree/v0.8.2/packages/format
