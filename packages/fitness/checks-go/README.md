...
> Go fitness checks for opensip-tools
...
```bash
npm install @opensip-tools/checks-go
```
...
- 📦 Source: https://github.com/opensip-ai/opensip-tools/tree/v2.12.0/packages/fitness/checks-go
