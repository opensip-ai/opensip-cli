/**
 * @opensip-cli/checks-typescript — TypeScript/Node.js fitness checks for opensip-cli
 *
 ...
 * `@opensip-cli/lang-typescript`, or are otherwise meaningful only inside the
