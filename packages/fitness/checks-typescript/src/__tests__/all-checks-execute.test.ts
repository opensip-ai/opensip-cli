...
beforeAll(async () => {
  ...
  allFixturePaths = [
    ...
    fixture(
      'src/routes/fastify-unvalidated.ts',
      [
    ...
    fixture(
      'src/util/unvalidated-arrays.ts',
      [
    ...
    fixture(
      'src/util/unvalidated-numbers.ts',
      [
    ...
    // --- React .map fixture ---
    fixture(
      'src/components/ListWithoutMemo.tsx',
      [
    ...
    fixture(
      'src/handlers/silent-returns.ts',
      [
    ...
    fixture(
      'src/streams/unbounded-buffer.ts',
      [
    ...
    fixture(
      'src/handlers/fail-fast-violation.ts',
      [
    ...
    fixture(
      'src/lifecycle/incomplete-dispose.ts',
      [
    ...
    fixture(
      'src/usecase/listing-fail-fast.ts',
      [
    ...
    fixture(
      'src/lifecycle/optional-chain.ts',
      [
    ...
    fixture(
      'src/streams/various-buffers.ts',
      [
    ...
    fixture(
      'src/repositories/scan-heavy-repository.ts',
      [
    ...
    fixture(
      'src/components/PlatformAware.tsx',
      [
