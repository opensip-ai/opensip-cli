...
function registerFitExports(mod: Record<string, unknown>, ctx: RegisterCtx): RegisteredCounts {
 ...
 */
export async function loadPlugin(plugin: DiscoveredPlugin, domain = 'fit'): Promise<LoadedPlugin> {
