...
> Python fitness checks for opensip-tools
...
```bash
npm install @opensip-tools/checks-python
```
...
- 📦 Source: https://github.com/opensip-ai/opensip-tools/tree/v2.11.0/packages/fitness/checks-python
