...
> Java fitness checks for opensip-cli
...
This package is published for the CLI and advanced plugin authors; most users should not install `@opensip-cli/checks-java` directly.
...
- 📦 Source: https://github.com/opensip-ai/opensip-cli/tree/v0.1.16/packages/fitness/checks-java
