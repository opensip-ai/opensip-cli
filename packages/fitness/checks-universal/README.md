...
> Cross-language fitness checks for opensip-tools
...
```bash
npm install @opensip-tools/checks-universal
```
...
- 📦 Source: https://github.com/opensip-ai/opensip-tools/tree/v2.10.0/packages/fitness/checks-universal
