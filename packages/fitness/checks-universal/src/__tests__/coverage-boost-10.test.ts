...
describe('test-file-naming directory walk', () => {
  ...
  beforeAll(() => {
    ...
    writeFixture(cwd, 'packages/a/__tests__/widget-checks.tsx', [
...
describe('sentry-pii-scrubbing detectors', () => {
  ...
  beforeAll(() => {
    ...
    writeFixture(cwd, 'src/init-no-filter.ts', [
    ...
    writeFixture(cwd, 'src/context-pii.ts', [
      'import * as Sentry from sentry',
    ...
    writeFixture(cwd, 'src/context-shorthand.ts', [
      'import * as Sentry from sentry',
    ...
    writeFixture(cwd, 'src/context-clean.ts', [
      'import * as Sentry from sentry',
    ...
    writeFixture(cwd, 'src/init-filtered.ts', [
      'import * as Sentry from sentry',
      'Sentry.init({',
      '  dsn: dsn,',
