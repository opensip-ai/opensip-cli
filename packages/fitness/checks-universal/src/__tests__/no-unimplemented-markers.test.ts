...
import { analyzeUnimplementedMarkers, noUnimplementedMarkers } from '../checks/no-unimplemented-markers.js'
...
describe('analyzeUnimplementedMarkers', () => {
  describe('TypeScript / JavaScript', () => {
    ...
    it('does NOT flag a normal string that merely contains a marker word', () => {
      const v = analyzeUnimplementedMarkers(`const msg = 'TODO: not implemented section header'`, 'a.ts')
      expect(v).toHaveLength(0)
    })
  ...
  describe('dispatch + edge cases', () => {
    ...
    it('counts at most one violation per line', () => {
      const v = analyzeUnimplementedMarkers(`throw new NotImplementedError('not implemented')`, 'a.ts')
      expect(v).toHaveLength(1)
    })
