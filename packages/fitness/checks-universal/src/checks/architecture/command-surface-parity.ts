/**
 * @fileoverview Every command resolves to a typed CommandSpec — no raw Commander
 * access from a tool (release 2.11.0 command plane, north-star Principle 6).
 *
 * The 2.11.0 command plane removed the two-tier privilege where tools touched
