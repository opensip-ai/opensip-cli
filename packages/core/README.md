...
> Core kernel for OpenSIP CLI — language adapters, plugin loader, errors, logger, IDs, retry, project config
...
This package is published for the CLI and advanced plugin authors; most users should not install `@opensip-cli/core` directly.
...
- 📦 Source: https://github.com/opensip-ai/opensip-cli/tree/v0.1.16/packages/core
