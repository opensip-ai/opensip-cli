 ...
 * touches when wiring a {@link CommandSpec} — render/exit/output/live-view
 * emitters only. Tool handlers still receive the full `ToolCliContext`; this
 * type documents the mount plane's dependency so host commands can mount with a
 * leaner context (ADR-0051 / P1-F6).
 *
