...
export const CLI_DIAGNOSTIC_CODES = {
  ...
  OPENSIP_CAPABILITY_PACK_UNTRUSTED: 'OPENSIP_CAPABILITY_PACK_UNTRUSTED',
  OPENSIP_CAPABILITY_SCOPE_ABI_MISMATCH: 'OPENSIP_CAPABILITY_SCOPE_ABI_MISMATCH',
  OPENSIP_POLICY_SOURCE_INVALID: 'OPENSIP_POLICY_SOURCE_INVALID',
  OPENSIP_POLICY_CONDITIONED: 'OPENSIP_POLICY_CONDITIONED',
  OPENSIP_POLICY_DENIED: 'OPENSIP_POLICY_DENIED',
} as const;
