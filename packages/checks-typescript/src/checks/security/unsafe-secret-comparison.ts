...
import { defineCheck, type CheckViolation, parseSource, walkNodes, getIdentifierName, isLiteral, isPropertyAccess, getASTLineNumber, ts } from '@opensip-tools/fitness'
