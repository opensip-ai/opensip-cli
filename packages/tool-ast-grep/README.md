...
> External Tool Adapter for ast-grep — wraps the ast-grep structural search scanner as an opensip-cli tool
...
This package is published for the CLI and advanced plugin authors; most users should not install `@opensip-cli/tool-ast-grep` directly.
...
- 📦 Source: https://github.com/opensip-ai/opensip-cli/tree/v0.5.1/packages/tool-ast-grep
