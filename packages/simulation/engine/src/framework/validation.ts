 ...
 * stamps the same `code: 'VALIDATION.SIMULATION.SCENARIO_INVALID'`).
 *
...
/** Registered replacement for the un-catalogued `VALIDATION.SIMULATION.SCENARIO_INVALID` literal. */
 ...
 * with the canonical `'VALIDATION.SIMULATION.SCENARIO_INVALID'` code if any
