/**
 * Agent-catalog content builder (ADR-0084) — the RUNTIME half of the
 * agent-catalog surface. The serializable catalog TYPES (CommandTier,
 * AgentCatalog, AgentCatalogBuildInput) stay in @opensip-cli/contracts; this
 * module builds the catalog content both the CLI `agent-catalog` command and
 * the `@opensip-cli/mcp` `get_agent_catalog` tool serve.
 *
