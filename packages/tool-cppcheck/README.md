...
> External Tool Adapter for Cppcheck — wraps C/C++ static analysis as an opensip-cli tool
...
This package is published for the CLI and advanced plugin authors; most users should not install `@opensip-cli/tool-cppcheck` directly.
...
- 📦 Source: https://github.com/opensip-ai/opensip-cli/tree/v0.5.0/packages/tool-cppcheck
