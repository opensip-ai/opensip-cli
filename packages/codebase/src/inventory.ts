...
const INPUT_INVALID = codebaseErrorCatalog.require('VALIDATION.CODEBASE.INVENTORY_INPUT_INVALID');
 ...
 *
 * @throws {ToolError} `VALIDATION.CODEBASE.INVENTORY_INPUT_INVALID` when `value` is present
 ...
 *
 * @throws {ToolError} `VALIDATION.CODEBASE.INVENTORY_INPUT_INVALID` when `deadlineMs` is
 ...
 *
 * @throws {ToolError} `VALIDATION.CODEBASE.INVENTORY_INPUT_INVALID` when a supplied
