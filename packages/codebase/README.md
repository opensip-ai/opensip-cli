...
> Bounded deterministic project inventory and package-manifest facts for OpenSIP CLI evidence consumers
...
This package is published for the CLI and advanced plugin authors; most users should not install `@opensip-cli/codebase` directly.
...
- 📦 Source: https://github.com/opensip-ai/opensip-cli/tree/v0.8.4/packages/codebase
