...
> External Tool Adapter for Semgrep — wraps the semgrep scanner as an opensip-cli tool
...
This package is published for the CLI and advanced plugin authors; most users should not install `@opensip-cli/tool-semgrep` directly.
...
- 📦 Source: https://github.com/opensip-ai/opensip-cli/tree/v0.4.2/packages/tool-semgrep
