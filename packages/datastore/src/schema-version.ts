...
/**
 * Current logical schema stamp for the bundled post-squash journal. Ten entries:
 ...
 * integrity indexes (0008) + host-plane namespace copy (0009). Bump this in
 * lockstep with the bundled journal entry count (or fold into the offset on the
 * next squash).
 */
export const LOGICAL_SCHEMA_VERSION = SCHEMA_VERSION_OFFSET + 10;
