...
> SQLite + Drizzle persistence layer for OpenSIP Tools — DataStore interface, backends, factory, schema migrations
...
```bash
npm install @opensip-tools/datastore
```
...
- 📦 Source: https://github.com/opensip-ai/opensip-tools/tree/v2.10.1/packages/datastore
