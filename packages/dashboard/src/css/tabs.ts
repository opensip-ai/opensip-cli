...
.tab { padding: 10px 20px; cursor: pointer; color: var(--text-dim); background: transparent; font: inherit; font-size: 13px; font-weight: 500; border: 0; border-bottom: 2px solid transparent; transition: color 0.15s, border-color 0.15s; display: flex; align-items: center; gap: 6px; }
