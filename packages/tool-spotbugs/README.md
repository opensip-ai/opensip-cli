...
> External Tool Adapter for SpotBugs — wraps Java bytecode analysis as an opensip-cli tool
...
This package is published for the CLI and advanced plugin authors; most users should not install `@opensip-cli/tool-spotbugs` directly.
...
- 📦 Source: https://github.com/opensip-ai/opensip-cli/tree/v0.5.0/packages/tool-spotbugs
