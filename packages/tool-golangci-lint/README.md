...
> External Tool Adapter for golangci-lint — wraps golangci-lint as an opensip-cli tool
...
This package is published for the CLI and advanced plugin authors; most users should not install `@opensip-cli/tool-golangci-lint` directly.
...
- 📦 Source: https://github.com/opensip-ai/opensip-cli/tree/v0.4.2/packages/tool-golangci-lint
