...
> External Tool Adapter for Ruff — wraps ruff check as an opensip-cli tool
...
This package is published for the CLI and advanced plugin authors; most users should not install `@opensip-cli/tool-ruff` directly.
...
- 📦 Source: https://github.com/opensip-ai/opensip-cli/tree/v0.8.3/packages/tool-ruff
