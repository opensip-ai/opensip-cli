...
[`@opensip-cli/external-tool-adapter`](https://github.com/opensip-ai/opensip-cli/blob/v0.5.2/packages/external-tool-adapter)
...
|---------|-------|-------|---------------|---------|
| [`@opensip-cli/tool-gitleaks`](https://github.com/opensip-ai/opensip-cli/blob/v0.5.2/packages/tool-gitleaks) | `gitleaks` | Committed secrets in the working tree | JSON (`parse`) | `local-only` |
| [`@opensip-cli/tool-osv-scanner`](https://github.com/opensip-ai/opensip-cli/blob/v0.5.2/packages/tool-osv-scanner) | `osv-scanner` | Dependency vulnerabilities | JSON (`parse`) | `local-only` |
| [`@opensip-cli/tool-trivy`](https://github.com/opensip-ai/opensip-cli/blob/v0.5.2/packages/tool-trivy) | `trivy` | Vulnerabilities + misconfigurations | SARIF (shared `ingestSarif`) | `local-only` |
| [`@opensip-cli/tool-semgrep`](https://github.com/opensip-ai/opensip-cli/blob/v0.5.2/packages/tool-semgrep) | `semgrep` | SAST / policy rules | SARIF (shared `ingestSarif`) | `networked` when using `--config auto` |
| [`@opensip-cli/tool-ast-grep`](https://github.com/opensip-ai/opensip-cli/blob/v0.5.2/packages/tool-ast-grep) | `ast-grep` | Structural search rules | stdout SARIF (`parseStdoutSarif`) | `local-only` |
| [`@opensip-cli/tool-ruff`](https://github.com/opensip-ai/opensip-cli/blob/v0.5.2/packages/tool-ruff) | `ruff` | Python lint diagnostics | JSON (`parse`) | `local-only` |
| [`@opensip-cli/tool-golangci-lint`](https://github.com/opensip-ai/opensip-cli/blob/v0.5.2/packages/tool-golangci-lint) | `golangci-lint` | Go lint aggregation | stdout JSON (`parse`) | `local-only` |
| [`@opensip-cli/tool-govulncheck`](https://github.com/opensip-ai/opensip-cli/blob/v0.5.2/packages/tool-govulncheck) | `govulncheck` | Go vulnerabilities | stdout JSON lines (`parse`) | `networked` |
| [`@opensip-cli/tool-cargo-deny`](https://github.com/opensip-ai/opensip-cli/blob/v0.5.2/packages/tool-cargo-deny) | `cargo-deny` | Rust dependency policy | stdout JSON lines (`parse`) | `networked` |
| [`@opensip-cli/tool-bandit`](https://github.com/opensip-ai/opensip-cli/blob/v0.5.2/packages/tool-bandit) | `bandit` | Python security issues | JSON (`parse`) | `local-only` |
| [`@opensip-cli/tool-pip-audit`](https://github.com/opensip-ai/opensip-cli/blob/v0.5.2/packages/tool-pip-audit) | `pip-audit` | Python dependency vulnerabilities | JSON (`parse`) | `networked` |
| [`@opensip-cli/tool-cargo-clippy`](https://github.com/opensip-ai/opensip-cli/blob/v0.5.2/packages/tool-cargo-clippy) | `cargo clippy` | Rust lint diagnostics | stdout JSON lines (`parse`) | `local-only` |
| [`@opensip-cli/tool-spotbugs`](https://github.com/opensip-ai/opensip-cli/blob/v0.5.2/packages/tool-spotbugs) | `spotbugs` | Java bytecode issues | SARIF (shared `ingestSarif`) | `local-only` |
| [`@opensip-cli/tool-pmd`](https://github.com/opensip-ai/opensip-cli/blob/v0.5.2/packages/tool-pmd) | `pmd` | Java source rules | SARIF (shared `ingestSarif`) | `local-only` |
| [`@opensip-cli/tool-dependency-check`](https://github.com/opensip-ai/opensip-cli/blob/v0.5.2/packages/tool-dependency-check) | `dependency-check` | Dependency vulnerabilities | SARIF (shared `ingestSarif`) | `local-only` with a pre-populated DB |
| [`@opensip-cli/tool-cppcheck`](https://github.com/opensip-ai/opensip-cli/blob/v0.5.2/packages/tool-cppcheck) | `cppcheck` | C/C++ static analysis | SARIF (shared `ingestSarif`) | `local-only` |
...
This shape is decided in [ADR-0090](https://github.com/opensip-ai/opensip-cli/blob/v0.5.2/docs/decisions/ADR-0090-external-tool-adapter-substrate.md)
(the substrate + worker dispatch), [ADR-0091](https://github.com/opensip-ai/opensip-cli/blob/v0.5.2/docs/decisions/ADR-0091-external-scanner-finding-ingestion.md)
(ingestion, artifacts, exit modeling), and [ADR-0092](https://github.com/opensip-ai/opensip-cli/blob/v0.5.2/docs/decisions/ADR-0092-external-adapter-network-auth-trust.md)
(network posture + the no-egress confidentiality rule).
[ADR-0139](https://github.com/opensip-ai/opensip-cli/blob/v0.5.2/docs/decisions/ADR-0139-host-owned-external-adapter-live-view.md)
keeps live rendering host-owned through a private progress bridge,
[ADR-0140](https://github.com/opensip-ai/opensip-cli/blob/v0.5.2/docs/decisions/ADR-0140-polyglot-external-adapter-package-contract.md)
records the adapter package contract, and
[ADR-0141](https://github.com/opensip-ai/opensip-cli/blob/v0.5.2/docs/decisions/ADR-0141-external-scanner-binary-ownership.md)
...
[`packages/tool-gitleaks/src/tool.ts`](https://github.com/opensip-ai/opensip-cli/blob/v0.5.2/packages/tool-gitleaks/src/tool.ts)),
...
[`ExternalToolAdapterSpec`](https://github.com/opensip-ai/opensip-cli/blob/v0.5.2/packages/external-tool-adapter/src/types.ts):
...
- **`metadata.id`** — a stable UUID ([ADR-0048](https://github.com/opensip-ai/opensip-cli/blob/v0.5.2/docs/decisions/ADR-0048-tool-stable-uuid-identity.md)).
...
[`ExternalCommandSpec`](https://github.com/opensip-ai/opensip-cli/blob/v0.5.2/packages/external-tool-adapter/src/types.ts):
...
[`AdapterRunContext`](https://github.com/opensip-ai/opensip-cli/blob/v0.5.2/packages/external-tool-adapter/src/types.ts):
...
`metadata` bag ([ADR-0042](https://github.com/opensip-ai/opensip-cli/blob/v0.5.2/docs/decisions/ADR-0042-tool-storage-contract-and-state-store.md)).
...
The gitleaks parser
([`parse-gitleaks-json.ts`](https://github.com/opensip-ai/opensip-cli/blob/v0.5.2/packages/tool-gitleaks/src/parse-gitleaks-json.ts))
...
[`AdapterDoctorReport`](https://github.com/opensip-ai/opensip-cli/blob/v0.5.2/packages/external-tool-adapter/src/doctor-command.ts)
...
([ADR-0054](https://github.com/opensip-ai/opensip-cli/blob/v0.5.2/docs/decisions/ADR-0054-tool-fault-isolation-boundary.md)) — a crashing
...
([ADR-0080](https://github.com/opensip-ai/opensip-cli/blob/v0.5.2/docs/decisions/ADR-0080-host-owned-artifact-write-seam.md)) — adapter
...
([ADR-0087](https://github.com/opensip-ai/opensip-cli/blob/v0.5.2/docs/decisions/ADR-0087-public-ecosystem-readiness-shelved.md): plan 03
...
trusted/private extensions ([ADR-0061](https://github.com/opensip-ai/opensip-cli/blob/v0.5.2/docs/decisions/ADR-0061-tool-platform-launch-posture-and-extension-trust-tiers.md)).
...
- [ADR-0090](https://github.com/opensip-ai/opensip-cli/blob/v0.5.2/docs/decisions/ADR-0090-external-tool-adapter-substrate.md) ·
  [ADR-0091](https://github.com/opensip-ai/opensip-cli/blob/v0.5.2/docs/decisions/ADR-0091-external-scanner-finding-ingestion.md) ·
  [ADR-0092](https://github.com/opensip-ai/opensip-cli/blob/v0.5.2/docs/decisions/ADR-0092-external-adapter-network-auth-trust.md) ·
  [ADR-0139](https://github.com/opensip-ai/opensip-cli/blob/v0.5.2/docs/decisions/ADR-0139-host-owned-external-adapter-live-view.md) ·
  [ADR-0140](https://github.com/opensip-ai/opensip-cli/blob/v0.5.2/docs/decisions/ADR-0140-polyglot-external-adapter-package-contract.md) ·
  [ADR-0141](https://github.com/opensip-ai/opensip-cli/blob/v0.5.2/docs/decisions/ADR-0141-external-scanner-binary-ownership.md) ·
  [ADR-0142](https://github.com/opensip-ai/opensip-cli/blob/v0.5.2/docs/decisions/ADR-0142-dependency-check-offline-safe-default.md)
