...
[`@opensip-cli/external-tool-adapter`](https://github.com/opensip-ai/opensip-cli/blob/v0.2.4/packages/external-tool-adapter)
...
|---------|-------|-------|---------------|---------|
| [`@opensip-cli/tool-gitleaks`](https://github.com/opensip-ai/opensip-cli/blob/v0.2.4/packages/tool-gitleaks) | `gitleaks` | Committed secrets in the working tree | JSON (`parse`) | `local-only` |
| [`@opensip-cli/tool-osv-scanner`](https://github.com/opensip-ai/opensip-cli/blob/v0.2.4/packages/tool-osv-scanner) | `osv-scanner` | Dependency vulnerabilities | JSON (`parse`) | `local-only` |
| [`@opensip-cli/tool-trivy`](https://github.com/opensip-ai/opensip-cli/blob/v0.2.4/packages/tool-trivy) | `trivy` | Vulnerabilities + misconfigurations | SARIF (shared `ingestSarif`) | `local-only` |
...
This shape is decided in [ADR-0090](https://github.com/opensip-ai/opensip-cli/blob/v0.2.4/docs/decisions/ADR-0090-external-tool-adapter-substrate.md)
(the substrate + worker dispatch), [ADR-0091](https://github.com/opensip-ai/opensip-cli/blob/v0.2.4/docs/decisions/ADR-0091-external-scanner-finding-ingestion.md)
(ingestion, artifacts, exit modeling), and [ADR-0092](https://github.com/opensip-ai/opensip-cli/blob/v0.2.4/docs/decisions/ADR-0092-external-adapter-network-auth-trust.md)
...
[`packages/tool-gitleaks/src/tool.ts`](https://github.com/opensip-ai/opensip-cli/blob/v0.2.4/packages/tool-gitleaks/src/tool.ts)),
...
[`ExternalToolAdapterSpec`](https://github.com/opensip-ai/opensip-cli/blob/v0.2.4/packages/external-tool-adapter/src/types.ts):
...
- **`metadata.id`** — a stable UUID ([ADR-0048](https://github.com/opensip-ai/opensip-cli/blob/v0.2.4/docs/decisions/ADR-0048-tool-stable-uuid-identity.md)).
...
[`ExternalCommandSpec`](https://github.com/opensip-ai/opensip-cli/blob/v0.2.4/packages/external-tool-adapter/src/types.ts):
...
[`AdapterRunContext`](https://github.com/opensip-ai/opensip-cli/blob/v0.2.4/packages/external-tool-adapter/src/types.ts):
...
`metadata` bag ([ADR-0042](https://github.com/opensip-ai/opensip-cli/blob/v0.2.4/docs/decisions/ADR-0042-tool-storage-contract-and-state-store.md)).
...
The gitleaks parser
([`parse-gitleaks-json.ts`](https://github.com/opensip-ai/opensip-cli/blob/v0.2.4/packages/tool-gitleaks/src/parse-gitleaks-json.ts))
...
[`AdapterDoctorReport`](https://github.com/opensip-ai/opensip-cli/blob/v0.2.4/packages/external-tool-adapter/src/doctor-command.ts)
...
([ADR-0054](https://github.com/opensip-ai/opensip-cli/blob/v0.2.4/docs/decisions/ADR-0054-tool-fault-isolation-boundary.md)) — a crashing
...
([ADR-0080](https://github.com/opensip-ai/opensip-cli/blob/v0.2.4/docs/decisions/ADR-0080-host-owned-artifact-write-seam.md)) — adapter
...
([ADR-0087](https://github.com/opensip-ai/opensip-cli/blob/v0.2.4/docs/decisions/ADR-0087-public-ecosystem-readiness-shelved.md): plan 03
...
trusted/private extensions ([ADR-0061](https://github.com/opensip-ai/opensip-cli/blob/v0.2.4/docs/decisions/ADR-0061-tool-platform-launch-posture-and-extension-trust-tiers.md)).
...
- [ADR-0090](https://github.com/opensip-ai/opensip-cli/blob/v0.2.4/docs/decisions/ADR-0090-external-tool-adapter-substrate.md) ·
  [ADR-0091](https://github.com/opensip-ai/opensip-cli/blob/v0.2.4/docs/decisions/ADR-0091-external-scanner-finding-ingestion.md) ·
  [ADR-0092](https://github.com/opensip-ai/opensip-cli/blob/v0.2.4/docs/decisions/ADR-0092-external-adapter-network-auth-trust.md)
</content>
</invoke>
