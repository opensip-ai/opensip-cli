...
same path bundled and installed tools do ([ADR-0030](https://github.com/opensip-ai/opensip-cli/blob/v0.1.2/docs/decisions/ADR-0030-authored-tool-discovery.md)).
