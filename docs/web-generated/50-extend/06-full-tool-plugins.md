...
See [ADR-0077](https://github.com/opensip-ai/opensip-cli/blob/v0.2.4/docs/decisions/ADR-0077-unified-tool-logging-and-error-reporting.md).
...
same path bundled and installed tools do ([ADR-0030](https://github.com/opensip-ai/opensip-cli/blob/v0.2.4/docs/decisions/ADR-0030-authored-tool-discovery.md)).
