...
See [ADR-0077](https://github.com/opensip-ai/opensip-cli/blob/v0.8.0/docs/decisions/ADR-0077-unified-tool-logging-and-error-reporting.md).
...
same path bundled and installed tools do ([ADR-0030](https://github.com/opensip-ai/opensip-cli/blob/v0.8.0/docs/decisions/ADR-0030-authored-tool-discovery.md)).
...
[ADR-0061](https://github.com/opensip-ai/opensip-cli/blob/v0.8.0/docs/decisions/ADR-0061-tool-platform-launch-posture-and-extension-trust-tiers.md).
...
- Deny-by-default trust gates for project-local and installed tools. Project-local
  ...
  paths ([ADR-0145](https://github.com/opensip-ai/opensip-cli/blob/v0.8.0/docs/decisions/ADR-0145-external-worker-datastore-capability-and-exact-worker-mode.md)).
