...
For walking the TypeScript AST instead of regex, see [Ban an API pattern](/docs/opensip-cli/60-guides/02-ban-an-api-pattern/) for the AST shape, and [`@opensip-cli/lang-typescript`](https://github.com/opensip-ai/opensip-cli/blob/v0.1.9/packages/languages/lang-typescript/src/index.ts) for the helper exports.
