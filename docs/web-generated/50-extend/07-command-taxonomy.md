...
[ADR-0061](https://github.com/opensip-ai/opensip-cli/blob/v0.1.18/docs/decisions/ADR-0061-tool-platform-launch-posture-and-extension-trust-tiers.md), and
...
[ADR-0084](https://github.com/opensip-ai/opensip-cli/blob/v0.1.18/docs/decisions/ADR-0084-mcp-server-surface.md).
