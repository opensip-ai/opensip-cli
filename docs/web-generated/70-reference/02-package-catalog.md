...
Last verified at v0.2.4 against `scripts/release-package-order.mjs` (the publishable
package source of truth) and the layer tables above:

- **42 publishable packages** total (all at `0.2.4`), plus one workspace-private
