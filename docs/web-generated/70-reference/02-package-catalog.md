...
Last verified at v0.8.2 against `scripts/release-package-order.mjs` (the publishable
package source of truth) and the layer tables above:

- **61 workspace packages** total: **58 publishable** (all at `0.8.2`) and three
