...
Last verified at v0.1.1 against:

- `packages/` directory listing — **33 publishable packages** total (all at `0.1.1`), plus one workspace-private test-support package:
