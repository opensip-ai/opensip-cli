...
Tool-owned: [`packages/fitness/engine/src/tool.ts`](https://github.com/opensip-ai/opensip-cli/blob/v0.2.3/packages/fitness/engine/src/tool.ts).
...
Tool-owned: [`packages/simulation/engine/src/tool.ts`](https://github.com/opensip-ai/opensip-cli/blob/v0.2.3/packages/simulation/engine/src/tool.ts).
...
Tool-owned: [`packages/yagni/engine/src/tool.ts`](https://github.com/opensip-ai/opensip-cli/blob/v0.2.3/packages/yagni/engine/src/tool.ts).
...
Tool-owned: [`packages/mcp/src/command.ts`](https://github.com/opensip-ai/opensip-cli/blob/v0.2.3/packages/mcp/src/command.ts) (the bundled `@opensip-cli/mcp` tool, [ADR-0084](https://github.com/opensip-ai/opensip-cli/blob/v0.2.3/docs/decisions/ADR-0084-mcp-server-surface.md)).
...
[ADR-0109](https://github.com/opensip-ai/opensip-cli/blob/v0.2.3/docs/decisions/ADR-0109-mcp-first-agent-guidance-init-refresh.md).
...
CLI-owned: [`packages/cli/src/commands/init.ts`](https://github.com/opensip-ai/opensip-cli/blob/v0.2.3/packages/cli/src/commands/init.ts).
...
Both subcommands compose declarations from the live tool registry and admitted manifests — the same source as [`config-and-capabilities.ts`](https://github.com/opensip-ai/opensip-cli/blob/v0.2.3/packages/cli/src/bootstrap/config-and-capabilities.ts). They do not open the SQLite datastore.

---

## `configure` — manage user-level settings

CLI-owned: [`packages/cli/src/commands/configure.ts`](https://github.com/opensip-ai/opensip-cli/blob/v0.2.3/packages/cli/src/commands/configure.ts). Interactive — writes the OpenSIP Cloud API key to `~/.opensip-cli/config.yml` and verifies it best-effort against the cloud entitlement endpoint.
...
unfiltered envelope ([ADR-0085](https://github.com/opensip-ai/opensip-cli/blob/v0.2.3/docs/decisions/ADR-0085-change-detection-substrate.md)).
...
or match content. See [ADR-0100](https://github.com/opensip-ai/opensip-cli/blob/v0.2.3/docs/decisions/ADR-0100-suite-per-step-verdict-and-aggregate-output.md).
...
CLI-owned: [`packages/cli/src/commands/plugin.ts`](https://github.com/opensip-ai/opensip-cli/blob/v0.2.3/packages/cli/src/commands/plugin.ts).
...
Tool-owned: [`@opensip-cli/external-tool-adapter`](https://github.com/opensip-ai/opensip-cli/blob/v0.2.3/packages/external-tool-adapter) + the three MVP adapter packages ([ADR-0090](https://github.com/opensip-ai/opensip-cli/blob/v0.2.3/docs/decisions/ADR-0090-external-tool-adapter-substrate.md) / [ADR-0091](https://github.com/opensip-ai/opensip-cli/blob/v0.2.3/docs/decisions/ADR-0091-external-scanner-finding-ingestion.md) / [ADR-0092](https://github.com/opensip-ai/opensip-cli/blob/v0.2.3/docs/decisions/ADR-0092-external-adapter-network-auth-trust.md)).
...
Adapters inherit the host-owned baseline ratchet ([ADR-0036](https://github.com/opensip-ai/opensip-cli/blob/v0.2.3/docs/decisions/ADR-0036-host-owned-baseline-ratchet-plane.md)) verbatim, the same as `fit`/`graph`:
...
CLI-owned: [`packages/cli/src/commands/completion.ts`](https://github.com/opensip-ai/opensip-cli/blob/v0.2.3/packages/cli/src/commands/completion.ts).
...
CLI-owned: [`packages/cli/src/commands/uninstall.ts`](https://github.com/opensip-ai/opensip-cli/blob/v0.2.3/packages/cli/src/commands/uninstall.ts).
...
[`paths.ts`](https://github.com/opensip-ai/opensip-cli/blob/v0.2.3/packages/core/src/lib/paths.ts),
[`logger.ts`](https://github.com/opensip-ai/opensip-cli/blob/v0.2.3/packages/core/src/lib/logger.ts)). Anything else in that
...
[ADR-0073](https://github.com/opensip-ai/opensip-cli/blob/v0.2.3/docs/decisions/ADR-0073-update-notification-policy.md)). The *fetch*
