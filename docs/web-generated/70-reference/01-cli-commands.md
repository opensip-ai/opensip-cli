...
duplicates are collapsed before output ([ADR-0098](https://github.com/opensip-ai/opensip-cli/blob/v0.1.18/docs/decisions/ADR-0098-host-owned-signal-dedup-and-precision-heatmaps.md)).
...
or match content. See [ADR-0100](https://github.com/opensip-ai/opensip-cli/blob/v0.1.18/docs/decisions/ADR-0100-suite-per-step-verdict-and-aggregate-output.md).
