...
[`config-and-capabilities.ts`](https://github.com/opensip-ai/opensip-cli/blob/v0.2.4/packages/cli/src/bootstrap/config-and-capabilities.ts).
...
See [ADR-0111](https://github.com/opensip-ai/opensip-cli/blob/v0.2.4/docs/decisions/ADR-0111-built-in-audit-suite-preset.md) for the
