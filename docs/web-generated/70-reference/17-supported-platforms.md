...
([`packages/core/src/lib/platform-support.ts`](https://github.com/opensip-ai/opensip-cli/blob/v0.8.2/packages/core/src/lib/platform-support.ts)) and is the authoritative
