...
[ADR-0163](https://github.com/opensip-ai/opensip-cli/blob/v0.8.0/docs/decisions/ADR-0163-local-cpu-profiling-independent-of-otel-export.md).
...
[ADR-0162](https://github.com/opensip-ai/opensip-cli/blob/v0.8.0/docs/decisions/ADR-0162-typescript-7-1-readiness.md) keeps TypeScript
