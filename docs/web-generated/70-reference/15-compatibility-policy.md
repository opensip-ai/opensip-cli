...
[`packages/core/src/lib/compatibility-policy.ts`](https://github.com/opensip-ai/opensip-cli/blob/v0.8.1/packages/core/src/lib/compatibility-policy.ts)
...
The registry lives in
[`packages/core/src/lib/platform-support.ts`](https://github.com/opensip-ai/opensip-cli/blob/v0.8.1/packages/core/src/lib/platform-support.ts)
