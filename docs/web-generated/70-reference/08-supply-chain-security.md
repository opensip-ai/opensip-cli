...
[ADR-0068](https://github.com/opensip-ai/opensip-cli/blob/v0.4.1/docs/decisions/ADR-0068-consumption-side-verification-policy.md) and
...
[ADR-0069](https://github.com/opensip-ai/opensip-cli/blob/v0.4.1/docs/decisions/ADR-0069-dependency-hygiene-automation-policy.md)) on a
...
```bash
curl -fsSL https://opensip.ai/cli/install.sh | OPENSIP_CLI_VERSION=0.4.1 bash
```
