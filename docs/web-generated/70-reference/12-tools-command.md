...
adapter table and prerequisites; [ADR-0141](https://github.com/opensip-ai/opensip-cli/blob/v0.8.1/docs/decisions/ADR-0141-external-scanner-binary-ownership.md)
