...
purpose: "Public documentation entry point for opensip-cli v0.8.0: product overview, fast paths, and the full reference map."
---
# opensip-cli Docs
...
This v0.8.0 doc set was rechecked against the source on 2026-07-11:
