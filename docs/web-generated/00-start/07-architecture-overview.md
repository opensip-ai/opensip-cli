...
- **[`../10-concepts/01-fitness-loop.md`](/docs/opensip-cli/10-concepts/01-fitness-loop/)** - one fitness check end to end, from definition to exit code.
- **[`../10-concepts/02-tool-plugin-model.md`](/docs/opensip-cli/10-concepts/02-tool-plugin-model/)** - how the CLI dispatches tools without knowing their internals.
- **[`../10-concepts/03-modular-monolith.md`](/docs/opensip-cli/10-concepts/03-modular-monolith/)** - the deeper package-layer narrative and dependency rule.
