...
> opensip fit
  ...
  150 Passed, 1 Failed (4 Errors, 0 Warnings) | Duration 8.1s
```
...
The third loop. *"What is reachable from where?"* Builds the project's static
...
| Understand the runtime layout (what's on disk) | [System context](/docs/opensip-cli/00-start/06-system-context/) |
| See the high-level architecture map | [Architecture overview](/docs/opensip-cli/00-start/07-architecture-overview/) |
| Go deeper on the architecture (contributors) | [Mental model](/docs/opensip-cli/10-concepts/) → [Architecture index](/docs/opensip-cli/) |
