...
> - Enough mechanical context that [`./01-what-is-opensip-tools.md`](/docs/opensip-tools/00-start/01-what-is-opensip-tools/) lands as *"oh, that's why"* instead of *"wait, what's a recipe?"*
...
opensip-tools publishes through npm trusted publishing/provenance and rejects OpenSIP package-level install hooks before release. For the remaining npm-install risk model, see [supply-chain security](/docs/opensip-tools/70-reference/08-supply-chain-security/).
...
2. **[`./01-what-is-opensip-tools.md`](/docs/opensip-tools/00-start/01-what-is-opensip-tools/)** — The product, the problem, the philosophy. What you just ran, conceptually.
3. **[`../60-guides/00-initialize-your-first-repo.md`](/docs/opensip-tools/60-guides/00-initialize-your-first-repo/)** — The careful repo-adoption version of this page.
4. **[`./05-vocabulary.md`](/docs/opensip-tools/00-start/05-vocabulary/)** — The terms used everywhere: *Tool, recipe, check, scenario, signaler, target, language adapter, plugin, session.*
5. **[`./06-system-context.md`](/docs/opensip-tools/00-start/06-system-context/)** — Where the binary sits between you, the codebase, CI, and OpenSIP Cloud.
