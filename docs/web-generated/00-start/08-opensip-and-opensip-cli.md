...
recorded in
[ADR-0122](https://github.com/opensip-ai/opensip-cli/blob/v0.7.0/docs/decisions/ADR-0122-agent-workflow-product-wedge.md).
...
[ADR-0095](https://github.com/opensip-ai/opensip-cli/blob/v0.7.0/docs/decisions/ADR-0095-ai-native-guardrail-platform-posture.md).
