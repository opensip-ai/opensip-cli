...
- **Rules.** Sonarqube ships thousands of pre-built rules; customizing them requires the (paid) Developer Edition or higher. opensip-cli ships 166 checks across seven packs and assumes you'll author project-specific ones in 15-line files.
...
| Common questions about adoption + edge cases | [FAQ](/docs/opensip-cli/00-start/04-faq/) |
