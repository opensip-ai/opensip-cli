...
[ADR-0072](https://github.com/opensip-ai/opensip-cli/blob/v0.2.2/docs/decisions/ADR-0072-i18n-posture.md).

---

### Does opensip-cli "phone home"?

**Not for telemetry.** Summary by surface ([ADR-0070](https://github.com/opensip-ai/opensip-cli/blob/v0.2.2/docs/decisions/ADR-0070-telemetry-and-outbound-network-posture.md)):
