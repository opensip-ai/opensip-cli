...
[ADR-0072](https://github.com/opensip-ai/opensip-cli/blob/v0.1.14/docs/decisions/ADR-0072-i18n-posture.md).

---

### Does opensip-cli "phone home"?

**Not for telemetry.** Summary by surface ([ADR-0070](https://github.com/opensip-ai/opensip-cli/blob/v0.1.14/docs/decisions/ADR-0070-telemetry-and-outbound-network-posture.md)):
...
**No.** No model calls, no embeddings, no agentic anything. Plain TypeScript CLI. You can build an AI tool *on top of* the Tool plugin contract — that's exactly what the contract is for, and the contract is documented in [plugin authoring](/docs/opensip-cli/50-extend/01-plugin-authoring/).
