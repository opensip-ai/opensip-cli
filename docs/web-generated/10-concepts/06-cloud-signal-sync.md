...
and [ADR-0073](https://github.com/opensip-ai/opensip-cli/blob/v0.1.15/docs/decisions/ADR-0073-update-notification-policy.md)). Disable
...
The unit of egress is a **`SignalBatch`** ([`packages/core/src/types/signal-batch.ts`](https://github.com/opensip-ai/opensip-cli/blob/v0.1.15/packages/core/src/types/signal-batch.ts)):
