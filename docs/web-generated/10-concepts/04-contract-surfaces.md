...
The structured stdout when `--json` is set — the **same envelope for every tool** (`fit`, `sim`, `graph`), per [ADR-0011](https://github.com/opensip-ai/opensip-cli/blob/v0.1.13/docs/decisions/ADR-0011-signal-output-currency-formatter-sink.md). Shape lives at [`packages/contracts/src/signal-envelope.ts`](https://github.com/opensip-ai/opensip-cli/blob/v0.1.13/packages/contracts/src/signal-envelope.ts):
...
see [ADR-0027](https://github.com/opensip-ai/opensip-cli/blob/v0.1.13/docs/decisions/ADR-0027-ga-parity-cutover.md).
