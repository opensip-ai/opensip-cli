...
The layer rule — "dependencies flow up only" — is enforced by [dependency-cruiser](https://github.com/opensip-ai/opensip-tools/blob/v2.5.0/.dependency-cruiser.cjs) at lint time. The relevant rules:
...
Real codebases have edge cases. This one has three, all written into [`.dependency-cruiser.cjs`](https://github.com/opensip-ai/opensip-tools/blob/v2.5.0/.dependency-cruiser.cjs).
