...
We trace one specific scenario: a single check named `no-console-log` (one of the `console-log` family of detectors in [`packages/fitness/checks-universal/src/checks/quality/code-structure/no-console-log.ts`](https://github.com/opensip-ai/opensip-cli/blob/v0.1.7/packages/fitness/checks-universal/src/checks/quality/code-structure/no-console-log.ts)) running inside `acme-api`. We follow it from the moment you type `opensip fit` to the moment your shell prompt reappears.
...
Source: [`packages/cli/src/index.ts`](https://github.com/opensip-ai/opensip-cli/blob/v0.1.7/packages/cli/src/index.ts)
...
4. Hand argv to Commander, which dispatches to the `fit` command spec's handler ([`packages/fitness/engine/src/tool.ts`](https://github.com/opensip-ai/opensip-cli/blob/v0.1.7/packages/fitness/engine/src/tool.ts) assembles the `commandSpecs`; the handler bodies live in the `cli/` spec modules alongside it).
...
Source: [`packages/core/src/lib/paths.ts`](https://github.com/opensip-ai/opensip-cli/blob/v0.1.7/packages/core/src/lib/paths.ts), the configure command for user-level settings, and `loadProjectConfig()` inside `executeFit()`.
...
Source: [`packages/core/src/plugins/discover.ts`](https://github.com/opensip-ai/opensip-cli/blob/v0.1.7/packages/core/src/plugins/discover.ts), [`packages/fitness/engine/src/plugins/`](https://github.com/opensip-ai/opensip-cli/blob/v0.1.7/packages/fitness/engine/src/plugins/), [`packages/cli/src/bootstrap/register-language-adapters.ts`](https://github.com/opensip-ai/opensip-cli/blob/v0.1.7/packages/cli/src/bootstrap/register-language-adapters.ts) (language-adapter registration).
...
Source: [`packages/targeting/src/resolve.ts`](https://github.com/opensip-ai/opensip-cli/blob/v0.1.7/packages/targeting/src/resolve.ts), [`packages/fitness/engine/src/framework/path-matcher.ts`](https://github.com/opensip-ai/opensip-cli/blob/v0.1.7/packages/fitness/engine/src/framework/path-matcher.ts), [`packages/fitness/engine/src/framework/scope-resolver.ts`](https://github.com/opensip-ai/opensip-cli/blob/v0.1.7/packages/fitness/engine/src/framework/scope-resolver.ts).
...
Source: [`packages/fitness/engine/src/framework/define-check.ts`](https://github.com/opensip-ai/opensip-cli/blob/v0.1.7/packages/fitness/engine/src/framework/define-check.ts), [`packages/fitness/engine/src/recipes/parallel-execution.ts`](https://github.com/opensip-ai/opensip-cli/blob/v0.1.7/packages/fitness/engine/src/recipes/parallel-execution.ts), [`packages/fitness/engine/src/recipes/sequential-execution.ts`](https://github.com/opensip-ai/opensip-cli/blob/v0.1.7/packages/fitness/engine/src/recipes/sequential-execution.ts).
...
Source: [`packages/core/src/types/signal.ts`](https://github.com/opensip-ai/opensip-cli/blob/v0.1.7/packages/core/src/types/signal.ts), [`packages/contracts/src/signal-envelope.ts`](https://github.com/opensip-ai/opensip-cli/blob/v0.1.7/packages/contracts/src/signal-envelope.ts), [`packages/fitness/engine/src/framework/result-builder.ts`](https://github.com/opensip-ai/opensip-cli/blob/v0.1.7/packages/fitness/engine/src/framework/result-builder.ts).
...
The `SignalEnvelope` ([`packages/contracts/src/signal-envelope.ts`](https://github.com/opensip-ai/opensip-cli/blob/v0.1.7/packages/contracts/src/signal-envelope.ts)) is the canonical artifact: `schemaVersion`, `tool`, `recipe?`, `runId`, `createdAt`, a `verdict` (score, passed, summary), a `units[]` sidecar (per-check ran/errored/timing facts), and the flat `signals[]` list. Anything that consumes the JSON output (CI, dashboard, the gate) reads the envelope (ADR-0011).
...
Source: [`packages/cli/src/ui/`](https://github.com/opensip-ai/opensip-cli/blob/v0.1.7/packages/cli/src/ui/), [`packages/fitness/engine/src/cli/fit.ts`](https://github.com/opensip-ai/opensip-cli/blob/v0.1.7/packages/fitness/engine/src/cli/fit.ts), [`packages/cli/src/open-report.ts`](https://github.com/opensip-ai/opensip-cli/blob/v0.1.7/packages/cli/src/open-report.ts).
