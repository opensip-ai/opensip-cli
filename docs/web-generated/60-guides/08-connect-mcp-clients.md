...
([ADR-0130](https://github.com/opensip-ai/opensip-cli/blob/v0.4.2/docs/decisions/ADR-0130-mcp-repo-scoped-session-reads.md)).
...
- [ADR-0084](https://github.com/opensip-ai/opensip-cli/blob/v0.4.2/docs/decisions/ADR-0084-mcp-server-surface.md) — design decisions and trust model
