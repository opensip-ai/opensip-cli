...
trust enforcement mature (see [ADR-0076](https://github.com/opensip-ai/opensip-cli/blob/v0.2.0/docs/decisions/ADR-0076-tool-authoring-template-and-helper-boundary.md)).
