...
`cli.reportFailure`. See the [full tool plugin guide](/docs/opensip-cli/50-extend/06-full-tool-plugins/)
and the [error and resiliency model](/docs/opensip-cli/80-implementation/09-error-and-resiliency-model/).
...
trust enforcement mature (see [ADR-0076](https://github.com/opensip-ai/opensip-cli/blob/v0.8.4/docs/decisions/ADR-0076-tool-authoring-template-and-helper-boundary.md)).
