...
| You want to ... | Go to |
|---|---|
| Understand the pipeline | [Stages and catalog](/docs/opensip-tools/40-graph/01-stages-and-catalog/) |
| Understand rules and baselines | [Rules and gating](/docs/opensip-tools/40-graph/02-rules-and-gating/) |
| Add a graph language adapter | [Adding a language](/docs/opensip-tools/40-graph/03-adding-a-language/) |
| Look up every graph flag | [CLI commands](/docs/opensip-tools/70-reference/01-cli-commands/#graph--static-call-graph--dead-end-analysis) |
