...
- [Sticky PR comment](/docs/opensip-cli/60-guides/examples/opensip-action-comment/)
- [Step summary](/docs/opensip-cli/60-guides/examples/opensip-action-summary/)
- [SARIF projection](/docs/opensip-cli/60-guides/examples/opensip-action-sarif/)
- [Pinned action / no-cloud CI example](/docs/opensip-cli/60-guides/examples/opensip-action-pinned-non-cloud/)
