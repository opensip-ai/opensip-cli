...
The workspace root [`tsconfig.json`](https://github.com/opensip-ai/opensip-cli/blob/v1.0.0/tsconfig.json) sets `target: ES2022`, `module: Node16`, `moduleResolution: Node16`, and `strict: true`. Each package has its own `tsconfig.json` that extends those settings.
...
Flat config at [`.config/eslint.config.mjs`](https://github.com/opensip-ai/opensip-cli/blob/v1.0.0/.config/eslint.config.mjs). The base layers:
...
[`packages/core/src/lib/errors.ts`](https://github.com/opensip-ai/opensip-cli/blob/v1.0.0/packages/core/src/lib/errors.ts) defines the workspace's error hierarchy:
...
Errors are mapped to user-facing suggestions by [`getErrorSuggestion`](https://github.com/opensip-ai/opensip-cli/blob/v1.0.0/packages/contracts/src/exit-codes.ts):
...
Defined exactly once in [`packages/contracts/src/exit-codes.ts`](https://github.com/opensip-ai/opensip-cli/blob/v1.0.0/packages/contracts/src/exit-codes.ts):
...
The structured logger is in [`packages/core/src/lib/logger.ts`](https://github.com/opensip-ai/opensip-cli/blob/v1.0.0/packages/core/src/lib/logger.ts). Every log entry carries:
