...
the [architecture map](/docs/opensip-cli/80-implementation/architecture-map/). This page owns the repository
...
- **[`architecture-map.md`](/docs/opensip-cli/80-implementation/architecture-map/)** — current package inventory and layer placement beneath `packages/`.
- **[`04-coding-standards.md`](/docs/opensip-cli/80-implementation/04-coding-standards/)** — source, test, import, logging, and error conventions.
- **[`05-layer-policy.md`](/docs/opensip-cli/80-implementation/05-layer-policy/)** — dependency direction enforced across workspace packages.
- **[`06-doc-conventions.md`](/docs/opensip-cli/80-implementation/06-doc-conventions/)** — how contributor-facing documentation is written and verified.
