...
in `BUNDLED_TOOL_PACKAGES` ([`bootstrap/register-tools-bundled.ts`](https://github.com/opensip-ai/opensip-cli/blob/v0.1.6/packages/cli/src/bootstrap/register-tools-bundled.ts))
