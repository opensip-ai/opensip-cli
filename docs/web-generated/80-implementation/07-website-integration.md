...
```ts
type DocManifest = {
  version: string;       // e.g. "0.1.14" — the opensip-cli release this docset matches
  rawBase: string;       // e.g. "https://raw.githubusercontent.com/opensip-ai/opensip-cli/v0.1.14/"
  pages: DocPage[];
  nav: NavSection[];
};
