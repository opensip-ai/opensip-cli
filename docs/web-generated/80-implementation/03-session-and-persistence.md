...
The logger is in [`packages/core/src/lib/logger.ts`](https://github.com/opensip-ai/opensip-tools/blob/v2.3.2/packages/core/src/lib/logger.ts). Every log entry carries:
