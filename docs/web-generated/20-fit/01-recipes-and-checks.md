...
A check is the result of `defineCheck()`. The configuration shape is in [`packages/fitness/engine/src/framework/check-config.ts`](https://github.com/opensip-ai/opensip-cli/blob/v0.1.2/packages/fitness/engine/src/framework/check-config.ts); the validator is Zod-driven, so misconfigured checks throw at definition time, not at run time.
...
A `Check` object ([`packages/fitness/engine/src/framework/check-types.ts:45`](https://github.com/opensip-ai/opensip-cli/blob/v0.1.2/packages/fitness/engine/src/framework/check-types.ts)):
...
The full input shape is in [`packages/fitness/engine/src/recipes/types.ts`](https://github.com/opensip-ai/opensip-cli/blob/v0.1.2/packages/fitness/engine/src/recipes/types.ts):
...
Inside the check, read your slice via `getCheckConfig<T>(slug)` ([`packages/fitness/engine/src/recipes/check-config.ts`](https://github.com/opensip-ai/opensip-cli/blob/v0.1.2/packages/fitness/engine/src/recipes/check-config.ts)):
