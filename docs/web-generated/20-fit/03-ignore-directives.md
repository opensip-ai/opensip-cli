...
The `DirectiveEntry` shape ([`packages/fitness/engine/src/framework/directive-inventory.ts`](https://github.com/opensip-ai/opensip-cli/blob/v0.2.4/packages/fitness/engine/src/framework/directive-inventory.ts)) carries:
