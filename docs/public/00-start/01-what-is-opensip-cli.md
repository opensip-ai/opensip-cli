...
|---|---|
| See what real fit / sim / graph / yagni code looks like | [Show me each loop](./02-show-me-the-loops.md) |
| Run the first smoke test right now | [Quick start](./00-quick-start.md) |
| Initialize a real repo carefully | [Initialize your first repo](../60-guides/00-initialize-your-first-repo.md) |
...
| See the high-level architecture map | [Architecture overview](./07-architecture-overview.md) |
