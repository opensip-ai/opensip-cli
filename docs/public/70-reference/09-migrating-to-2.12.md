...
the long-lived 2.x major ([ADR-0012](../../decisions/ADR-0012-versioning-and-release-policy.md));
...
- Every environment variable the CLI reads is now declared and governed; see the
  generated [environment-variable reference](./10-environment-variables.md). No
