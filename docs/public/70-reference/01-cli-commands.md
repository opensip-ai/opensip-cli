...
`mcp` is **project-scoped and no-init capable** ([ADR-0170](../../decisions/ADR-0170-cache-first-runtime-evidence-continuity.md)):
...
([ADR-0130](../../decisions/ADR-0130-mcp-repo-scoped-session-reads.md)). A
...
| `trust <package>` | Grants operator trust to a capability pack on the **user-level** global config. The grant records the exact package id bound to the pack's provenance (its `opensipTools` manifest hash) resolved at grant time — re-run after the pack legitimately changes ([ADR-0171](../../decisions/ADR-0171-capability-pack-admission-trusts-operator-config.md)). |
...
[ADR-0073](../../decisions/ADR-0073-update-notification-policy.md)). The *fetch*
