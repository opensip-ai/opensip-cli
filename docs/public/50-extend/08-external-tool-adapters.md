...
flow is in the [CLI command reference](../70-reference/01-cli-commands.md#external-tool-adapters-opt-in).

This shape is decided in [ADR-0090](../../decisions/ADR-0090-external-tool-adapter-substrate.md)
...
[full Tool plugin](./06-full-tool-plugins.md) or a
[check pack](./03-publishable-packs.md) — an adapter is specifically the "wrap a
binary" path.
...
[`packages/tool-gitleaks/src/tool.ts`](../../../packages/tool-gitleaks/src/tool.ts)),
...
[`ExternalToolAdapterSpec`](../../../packages/external-tool-adapter/src/types.ts):
...
- **`metadata.id`** — a stable UUID ([ADR-0048](../../decisions/ADR-0048-tool-stable-uuid-identity.md)).
...
[`ExternalCommandSpec`](../../../packages/external-tool-adapter/src/types.ts):
...
[`AdapterRunContext`](../../../packages/external-tool-adapter/src/types.ts):
...
`metadata` bag ([ADR-0042](../../decisions/ADR-0042-tool-storage-contract-and-state-store.md)).
...
The gitleaks parser
([`parse-gitleaks-json.ts`](../../../packages/tool-gitleaks/src/parse-gitleaks-json.ts))
...
[`AdapterDoctorReport`](../../../packages/external-tool-adapter/src/doctor-command.ts)
...
([ADR-0054](../../decisions/ADR-0054-tool-fault-isolation-boundary.md)) — a crashing
...
output; see [Command surface taxonomy](./07-command-taxonomy.md).
...
([ADR-0080](../../decisions/ADR-0080-host-owned-artifact-write-seam.md)) — adapter
...
([ADR-0087](../../decisions/ADR-0087-public-ecosystem-readiness-shelved.md): plan 03
...
trusted/private extensions ([ADR-0061](../../decisions/ADR-0061-tool-platform-launch-posture-and-extension-trust-tiers.md)).
...
- [CLI command reference — External tool adapters](../70-reference/01-cli-commands.md#external-tool-adapters-opt-in)
- [`tools` command](../70-reference/12-tools-command.md)
