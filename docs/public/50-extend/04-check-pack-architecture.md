...
See [`80-implementation/02-plugin-loader.md`](../80-implementation/02-plugin-loader.md) for the resolution rules and how `plugins.autoDiscoverChecks: false` lets you opt out of the name-pattern path entirely.
