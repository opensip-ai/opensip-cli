...
- **Reference for every check that ships** → [Checks reference](../70-reference/05-checks-index.md). Browse all 160 built-in checks with descriptions and links to source.
