...
the three-segment convention documented in [Coding standards](../80-implementation/04-coding-standards.md).
...
[the tool-plugin model](../10-concepts/02-tool-plugin-model.md).
...
- [**Command surface taxonomy**](./07-command-taxonomy.md) — Tier-1/2/3 grammar, nested `parent`, export `--format`, internal visibility.
