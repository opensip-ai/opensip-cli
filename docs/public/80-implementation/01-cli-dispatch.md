...
[`runCommandSpecAction`](../../../packages/cli/src/commands/run-command-spec-action.ts).
...
taxonomy aligned ([ADR-0131](../../decisions/ADR-0131-shared-dispatch-pipeline-suite-exit-capture.md)).
...
MCP ([ADR-0154](../../decisions/ADR-0154-declarative-runtime-handler-bridge.md)).
