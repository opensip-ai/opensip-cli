...
for lifecycle/freshness, [ADR-0149](../../decisions/ADR-0149-bounded-labelled-mcp-audit-evidence.md)
for query/evidence bounds, and [ADR-0147](../../decisions/ADR-0147-public-graph-read-and-fail-closed-package-boundaries.md)
