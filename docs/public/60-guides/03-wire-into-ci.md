...
artifact is required; see the [report reference](../70-reference/06-dashboard.md).
...
- [Sticky PR comment](./examples/opensip-action-comment.md)
- [Step summary](./examples/opensip-action-summary.md)
- [SARIF projection](./examples/opensip-action-sarif.md)
- [Pinned action / no-cloud CI example](./examples/opensip-action-pinned-non-cloud.md)
...
[Public benchmarks](../70-reference/12-public-benchmarks.md).
...
[Performance profiling](../70-reference/16-performance-profiling.md).
