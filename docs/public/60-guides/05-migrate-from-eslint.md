...
| You want to … | Go to … |
|---|---|
| See concrete code for a banned-API check (which ESLint also handles) | [Ban an API pattern](./02-ban-an-api-pattern.md) |
| See the full ESLint / Semgrep / Sonarqube / Snyk comparison | [vs. other tools](../00-start/03-vs-other-tools.md) |
| Add opensip-tools to your CI pipeline | [Wire into CI](./03-wire-into-ci.md) |
| Write your first architectural rule | [Write your first check](./01-write-your-first-check.md) |
