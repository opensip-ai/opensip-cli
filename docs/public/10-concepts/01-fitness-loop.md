...
Source: [`packages/cli/src/ui/`](../../../packages/cli/src/ui/), [`packages/fitness/engine/src/cli/fit.ts`](../../../packages/fitness/engine/src/cli/fit.ts), [`packages/cli/src/open-report.ts`](../../../packages/cli/src/open-report.ts).
