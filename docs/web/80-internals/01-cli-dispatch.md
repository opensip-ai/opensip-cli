...
- **[`02-plugin-loader.md`](/docs/opensip-tools/80-internals/02-plugin-loader/)** — what happens inside `loadDiscoveredTools()` and inside the Tool's lazy plugin loading.
- **[`03-session-and-persistence.md`](/docs/opensip-tools/80-internals/03-session-and-persistence/)** — what gets written to disk during and after a run.
