...
38. [**CLI dispatch**](/docs/opensip-tools/80-internals/01-cli-dispatch/) — argv parsing, tool registration, command tree assembly.
39. [**Plugin loader**](/docs/opensip-tools/80-internals/02-plugin-loader/) — Source-file auto-discovery, npm-package pinning, `plugin sync`.
40. [**Session and persistence**](/docs/opensip-tools/80-internals/03-session-and-persistence/) — Runtime dir layout, sessions, reports, logs, cache, baseline.
41. [**Coding standards**](/docs/opensip-tools/80-internals/04-coding-standards/) — TS strictness, error handling, exit codes, ESLint posture.
42. [**Layer policy**](/docs/opensip-tools/80-internals/05-layer-policy/) — Dependency-cruiser rules, allowed imports, why the kernel can't import a tool.
43. [**Doc conventions**](/docs/opensip-tools/80-internals/06-doc-conventions/) — Voice, frontmatter, diagrams, verification trails.
44. [**Website integration**](/docs/opensip-tools/80-internals/07-website-integration/) — How opensip.ai consumes `docs/web/`: proxy, route, manifest contract.
...
See [`./80-internals/06-doc-conventions.md`](/docs/opensip-tools/80-internals/06-doc-conventions/) for the full conventions.
