...
Real codebases have edge cases. This one has two, both written into [`.dependency-cruiser.cjs`](https://github.com/opensip-ai/opensip-tools/blob/v1.0.10/.dependency-cruiser.cjs).
