...
The workspace root [`tsconfig.json`](https://github.com/opensip-ai/opensip-tools/blob/v1.0.10/tsconfig.json) sets `target: ES2022`, `module: Node16`, `moduleResolution: Node16`, and `strict: true`. Each package has its own `tsconfig.json` that extends those settings.
...
Errors are mapped to user-facing suggestions by [`getErrorSuggestion`](https://github.com/opensip-ai/opensip-tools/blob/v1.0.10/packages/contracts/src/exit-codes.ts):
...
- **[`02-layer-policy.md`](/docs/opensip-tools/90-conventions/02-layer-policy/)** — the dep-cruiser config, rule by rule, with rationale.
- **[`03-doc-conventions.md`](/docs/opensip-tools/90-conventions/03-doc-conventions/)** — voice, frontmatter, and verification trails for documentation.
- **[`../80-reference/01-package-catalog.md`](/docs/opensip-tools/80-reference/01-package-catalog/)** — the workspace package list these standards apply to.
