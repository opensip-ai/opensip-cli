...
Use `[**Title**](/docs/opensip-tools/90-conventions/path/)` for prominent cross-links and `[`identifier`](/docs/opensip-tools/90-conventions/path/)` for in-line code references.
...
Most docs end with a "What's next" section. A few — especially the reference docs (`80-reference/`) — also have a "Verification trail" section:
...
- **[`01-coding-standards.md`](/docs/opensip-tools/90-conventions/01-coding-standards/)** — code conventions (the parallel to this doc, for source).
- **[`02-layer-policy.md`](/docs/opensip-tools/90-conventions/02-layer-policy/)** — the dep-cruiser rules.
