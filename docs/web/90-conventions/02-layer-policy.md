...
For the deeper rationale (why a separate package, why not core, why not contracts), see [`../50-runtime/03-session-and-persistence.md`](/docs/opensip-tools/50-runtime/03-session-and-persistence/) and the persistence-migration decisions log.
