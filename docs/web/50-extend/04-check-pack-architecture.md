...
See [`80-internals/02-plugin-loader.md`](/docs/opensip-tools/80-internals/02-plugin-loader/) for the resolution rules and how `plugins.autoDiscoverChecks: false` lets you opt out of the name-pattern path entirely.
