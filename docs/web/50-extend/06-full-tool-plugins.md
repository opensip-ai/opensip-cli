...
- [**Coding standards**](/docs/opensip-tools/80-internals/04-coding-standards/) — the style and structure conventions used throughout opensip-tools (handy if you're contributing back).
