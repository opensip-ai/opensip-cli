...
- A project directory you don't mind a scaffold landing in. Any language from the [supported six](/docs/opensip-tools/00-orientation/03-system-context/) — TypeScript, Rust, Python, Java, Go, C/C++ — works; this page assumes whatever you have.
