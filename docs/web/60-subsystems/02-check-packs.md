...
For the full walkthrough — boilerplate, testing, publishing — see [`70-surfaces/02-plugin-authoring.md`](/docs/opensip-tools/70-surfaces/02-plugin-authoring/).
...
- **[`03-architecture-gate.md`](/docs/opensip-tools/60-subsystems/03-architecture-gate/)** — the regression-detection workflow built on top of check output.
- **[`../70-surfaces/02-plugin-authoring.md`](/docs/opensip-tools/70-surfaces/02-plugin-authoring/)** — full walkthrough of authoring a pack from scratch.
- **[`../80-reference/01-package-catalog.md`](/docs/opensip-tools/80-reference/01-package-catalog/)** — every pack's package, key exports, layer.
