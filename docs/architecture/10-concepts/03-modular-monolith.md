...
This document is the conceptual map. For the lookup-shaped catalog of every package's role and exports, jump to [`70-reference/02-package-catalog.md`](../70-reference/02-package-catalog.md). For the literal dep-cruiser rules, see [`80-internals/05-layer-policy.md`](../80-internals/05-layer-policy.md).
...
- **[`../80-internals/05-layer-policy.md`](../80-internals/05-layer-policy.md)** — the dep-cruiser config, rule by rule, with rationale.
