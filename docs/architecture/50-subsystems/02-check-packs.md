...
For the full walkthrough — boilerplate, testing, publishing — see [`60-surfaces/02-plugin-authoring.md`](../60-surfaces/02-plugin-authoring.md).
...
- **[`../60-surfaces/02-plugin-authoring.md`](../60-surfaces/02-plugin-authoring.md)** — full walkthrough of authoring a pack from scratch.
- **[`../70-reference/01-package-catalog.md`](../70-reference/01-package-catalog.md)** — every pack's package, key exports, layer.
