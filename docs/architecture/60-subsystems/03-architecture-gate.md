...
The reader is forgiving. From [`packages/fitness/engine/src/gate.ts:287`](../../../packages/fitness/engine/src/gate.ts) (`extractViolationsFromSarif`):
...
- **[`../70-surfaces/01-cli-command-tree.md`](../70-surfaces/01-cli-command-tree.md)** — every gate flag in the lookup-shaped reference.
- **[`../20-the-fit-loop/04-output-gate-sarif.md`](../20-the-fit-loop/04-output-gate-sarif.md)** — the wider context of fit output paths the gate fits into.
- **[`../20-the-fit-loop/03-ignore-directives.md`](../20-the-fit-loop/03-ignore-directives.md)** — when to use directives vs. baselining.
