...
Flat config at [`eslint.config.mjs`](../../../eslint.config.mjs). The base layers:
...
Adding a new exit code is a major-version change — see [`10-mental-model/04-contract-surfaces.md`](../10-mental-model/04-contract-surfaces.md).

---

## Logging

The structured logger is in [`packages/core/src/lib/logger.ts`](../../../packages/core/src/lib/logger.ts). Every log entry carries:
...
- **[`02-layer-policy.md`](./02-layer-policy.md)** — the dep-cruiser config, rule by rule, with rationale.
- **[`03-doc-conventions.md`](./03-doc-conventions.md)** — voice, frontmatter, and verification trails for documentation.
- **[`../70-reference/01-package-catalog.md`](../70-reference/01-package-catalog.md)** — the workspace package list these standards apply to.
