...
- **[`../50-subsystems/03-architecture-gate.md`](../50-subsystems/03-architecture-gate.md)** — the gate's full behavior and the baseline format.
- **[`../60-surfaces/03-dashboard.md`](../60-surfaces/03-dashboard.md)** — the HTML report's structure and the `dashboard` command.
- **[`../70-reference/02-configuration.md`](../70-reference/02-configuration.md)** — `opensip-tools.config.yml` schema (the one bit of project state that's not in `.runtime/`).
