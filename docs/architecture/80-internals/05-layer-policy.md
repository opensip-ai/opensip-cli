...
For the deeper rationale (why a separate package, why not core, why not contracts), see [`../80-internals/03-session-and-persistence.md`](../80-internals/03-session-and-persistence.md) and the persistence-migration decisions log.
