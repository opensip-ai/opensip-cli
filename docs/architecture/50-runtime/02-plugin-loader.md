...
[`packages/cli/src/index.ts:68-73`](../../../packages/cli/src/index.ts) registers the six bundled language adapters at module load time:
...
- **[`../70-surfaces/02-plugin-authoring.md`](../70-surfaces/02-plugin-authoring.md)** — how to build a check pack, scenario pack, or Tool that gets discovered by this loader.
