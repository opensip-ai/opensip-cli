...
Every adapter MUST pass the contract test suite at [`packages/graph/engine/src/__tests__/lang-adapter-contract.test.ts`](../../../packages/graph/engine/src/__tests__/lang-adapter-contract.test.ts). It validates the nine behavioral invariants from [`docs/plans/11-graph-language-adapter-contract.md`](../../plans/11-graph-language-adapter-contract.md) §3:
...
Per-rule fidelity expectations (from [plan 10 §6](../../plans/10-graph-language-pluggability.md)):
...
- The contract docs ([`10`](../../plans/10-graph-language-pluggability.md) and [`11`](../../plans/11-graph-language-adapter-contract.md)) discuss every design decision and call out deferred questions.
...
- **[`docs/plans/10-graph-language-pluggability.md`](../../plans/10-graph-language-pluggability.md)** — the master plan covering motivation, sequencing, and acceptance gates for the language-pluggability initiative.
