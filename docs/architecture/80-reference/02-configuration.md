...
See [`20-the-fit-loop/02-targets-and-scope.md`](../20-the-fit-loop/02-targets-and-scope.md) for the resolution semantics.
...
See [`50-runtime/02-plugin-loader.md`](../50-runtime/02-plugin-loader.md) for the loader semantics and the resolution order across the three paths.
...
- **[`03-json-output-schema.md`](./03-json-output-schema.md)** — the `CliOutput` shape that the runs emit.
- **[`../20-the-fit-loop/02-targets-and-scope.md`](../20-the-fit-loop/02-targets-and-scope.md)** — how targets interact with check scopes.
- **[`../50-runtime/02-plugin-loader.md`](../50-runtime/02-plugin-loader.md)** — how `plugins.<domain>:` is consumed.
