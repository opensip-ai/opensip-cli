...
These mirror the conceptual six-stage pipeline ([`../40-the-graph-loop/01-stages-and-catalog.md`](../40-the-graph-loop/01-stages-and-catalog.md)). Stages can't reach forward; visitors and resolvers share helpers, not each other; rules and renderers consume frozen data.
