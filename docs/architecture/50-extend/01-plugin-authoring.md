...
| 3 | **Project-local sim scenario** — a `.mjs` file under `opensip-tools/sim/scenarios/` | Run load / chaos / invariant simulations against your service. | ~30 lines | [Project-local plugins](./02-project-local-plugins.md) |
