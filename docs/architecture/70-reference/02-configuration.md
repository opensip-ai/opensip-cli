...
See [`40-runtime/02-plugin-loader.md`](../40-runtime/02-plugin-loader.md) for the loader semantics.
...
- **[`../40-runtime/02-plugin-loader.md`](../40-runtime/02-plugin-loader.md)** — how `plugins.<domain>:` is consumed.
