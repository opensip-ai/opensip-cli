...
**See also:** [`80-internals/03-session-and-persistence.md`](../80-internals/03-session-and-persistence.md).
...
**See also:** [`80-internals/02-plugin-loader.md`](../80-internals/02-plugin-loader.md).
