...
Source: [`packages/core/src/plugins/discover.ts`](../../../packages/core/src/plugins/discover.ts), [`packages/fitness/engine/src/plugins/`](../../../packages/fitness/engine/src/plugins/), [`packages/cli/src/index.ts:68-73`](../../../packages/cli/src/index.ts) (language-adapter registration).
