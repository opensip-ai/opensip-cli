...
4. Hand argv to Commander, which dispatches to `fitnessTool`'s `fit` action handler ([`packages/fitness/engine/src/tool.ts:118`](../../../packages/fitness/engine/src/tool.ts)).
...
Source: [`packages/core/src/lib/paths.ts`](../../../packages/core/src/lib/paths.ts), the configure command for user-level settings, and `loadProjectConfig()` inside `executeFit()`.
...
Source: [`packages/core/src/plugins/discover.ts`](../../../packages/core/src/plugins/discover.ts), [`packages/fitness/engine/src/plugins/`](../../../packages/fitness/engine/src/plugins/), [`packages/cli/src/index.ts:64-69`](../../../packages/cli/src/index.ts) (language-adapter registration).
...
Source: [`packages/fitness/engine/src/recipes/registry.ts`](../../../packages/fitness/engine/src/recipes/registry.ts), [`packages/fitness/engine/src/recipes/built-in-recipes.ts`](../../../packages/fitness/engine/src/recipes/built-in-recipes.ts).
...
The recipe service ([`packages/fitness/engine/src/recipes/service.ts`](../../../packages/fitness/engine/src/recipes/service.ts)) projects the recipe's `config:` map (per-check parameter overrides) into module-level state so each check can read its slice via `getCheckConfig<T>(slug)`.
...
Source: [`packages/fitness/engine/src/framework/define-check.ts`](../../../packages/fitness/engine/src/framework/define-check.ts), [`packages/fitness/engine/src/recipes/parallel-execution.ts`](../../../packages/fitness/engine/src/recipes/parallel-execution.ts), [`packages/fitness/engine/src/recipes/sequential-execution.ts`](../../../packages/fitness/engine/src/recipes/sequential-execution.ts).
