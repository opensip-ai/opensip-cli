...
- **[`../70-reference/01-package-catalog.md`](../70-reference/01-package-catalog.md)** — the packages you can depend on.
- **[`../80-conventions/01-coding-standards.md`](../80-conventions/01-coding-standards.md)** — the style and structure conventions used throughout opensip-tools (handy if you're contributing back).
